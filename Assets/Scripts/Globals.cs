...
public class Globals : MonoBehaviour
{
    ...
    public static readonly List<LevelData> LEVEL_LIST = new List<LevelData> {
        ...
        new LevelData("Departure A", "G2-2"), new LevelData("Trainyard", "S2-3"), new LevelData("Narrow Escape", "S2-4"),
    ...
    public static readonly List<string> AUTOPLAY_LIST = new List<string> { "S1-1", "G1-1", "G1-2", "G1-3", "S1-2",
        "G1-4", "G1-5", "G1-6", "S1-3", "S2-1", "G2-1", "S2-2", "G2-2", "S2-3", "S2-4", "S3-1", "S3-2", "S3-3", "S3-4", 
