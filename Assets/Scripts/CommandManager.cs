    ...
    public void Command()
    {
        ...
        switch (itemName)
        {
            case "Walk":
                ...
                MenuManager.instance.MoveMenu(PlayerMover.instance.transform.position, Mathf.FloorToInt(PlayerMover.instance.GetComponent<FieldUnit>().ap / 2));
                break;
            case "Sprint":
                MenuManager.context = MenuManager.Context.MapMove;
                MenuManager.instance.ShowMenu(children);
                current = this;
                MenuManager.instance.MoveMenu(PlayerMover.instance.transform.position, Mathf.Min(3, PlayerMover.instance.GetComponent<FieldUnit>().ap));
                break;
            case "Firearm":
                MenuManager.context = MenuManager.Context.UnitSelect;
                MenuManager.instance.ShowMenu(children);
                current = this;
                if(PlayerMover.instance.GetComponent<FieldUnit>().ap >= 2)
...
public class CommandManager : MonoBehaviour
{
    ...
    public static void MapCommand(MenuManager.Context context, Vector2 position)
    {
        ...
        switch (MenuManager.context)
        {
            case MenuManager.Context.MapMove:
                ...
                PlayerMover.instance.GetComponent<FieldUnit>().ap -= distance * (sprinting ? 1 : 2);
            ...
            case MenuManager.Context.UnitSelect:
                ...
                else
                {
                    ...
                    PlayerMover.instance.GetComponent<FieldUnit>().ap -= 2;
                }
                break;
        }
    }
    ...
    {
        PlayerMover.instance.GetComponent<FieldUnit>().ap = 0;
        EnemyList.EnemyTurn();
        MenuManager.instance.ClearOptions();
    }
