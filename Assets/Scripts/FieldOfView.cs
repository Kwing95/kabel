...
public class FieldOfView : MonoBehaviour
{
    ...
    private void RestoreDefaultSettings()
    {
        ...
        obstacleMask = 1; // Unity calls this "TransparentFX" but it's "Default"

        meshResolution = 1;
        edgeResolveIterations = 4;
        edgeDstThreshold = 0.5f;
        meshSortingLayer = "Player";
    }
    ...
    void FindVisibleTargets()
    {
        ...
        foreach (Collider elt in targetsInViewRadius)
            Debug.Log(elt);
    ...
    public Vector3 DirFromAngle(float angleInDegrees, bool angleIsGlobal)
    {
        ...
        return new Vector3(Mathf.Sin(angleInDegrees * Mathf.Deg2Rad), Mathf.Cos(angleInDegrees * Mathf.Deg2Rad), -0.1f);
    }
